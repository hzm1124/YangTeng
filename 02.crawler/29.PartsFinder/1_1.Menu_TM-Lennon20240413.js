// ==UserScript==
// @name         PartsFinder爬虫-Search
// @namespace    https://github.com/lennon1124/YangTeng
// @version      2024.04.13
// @description  Crawler
// @author       Lennon
// @match        *://partsfinder.bilsteingroup.com/*
// @icon         https://partsfinder.bilsteingroup.com/favicon.ico
// @grant        none
// ==/UserScript==
...
(function() {
    ...
    window.onload = function() {
        ...
        let list_part = document.querySelectorAll('a.detail-page-link');
        for(let i=0; i<list_part.length; i++) {
            array_data[i] = {};
            array_data[i]['No.'] = i + 1;
            array_data[i]['Url'] = 'https://partsfinder.bilsteingroup.com' + list_part[i].getAttribute('href').trim();
        }
