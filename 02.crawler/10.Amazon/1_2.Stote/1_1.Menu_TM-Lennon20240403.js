...
(function() {
    ...
    window.onload = function() {
        ...
        let list_part = document.querySelectorAll('li[data-testid="product-grid-item"] a[data-testid="grid-item-image"]');
        for(let i=0; i<list_part.length; i++) {
            array_data[i] = {};
            array_data[i]['No.'] = i + 1;
            array_data[i]['Url'] = 'https://www.amazon.com' + list_part[i].getAttribute('href').trim();
        }
