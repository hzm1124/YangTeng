...
(function() {
    ...
    window.onload = function() {
        ...
        let list_part = document.querySelectorAll('div[data-component-type="s-search-result"]');
        for(let i=0; i<list_part.length; i++) {
            array_data[i] = {};
            array_data[i]['Page'] = param_page;
            array_data[i]['No.'] = i + 1;
            array_data[i]['Url'] = 'https://www.amazon.com' + list_part[i].querySelectorAll('a.a-link-normal.s-underline-text.s-underline-link-text.s-link-style.a-text-normal')[0].getAttribute('href').trim();
        }
        ...
        // next
        window.location.href = 'https://www.amazon.com' + document.querySelector('a.s-pagination-item.s-pagination-next.s-pagination-button.s-pagination-separator').getAttribute('href').trim();
    }
})();