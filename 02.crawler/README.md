...
- |网址|爬前操作|目录字段|内容字段|爬取方法|
  ...
  |13. [1AAuto](https://www.1aauto.com/search?q=brake+calipers)|`A-Z`|`Menu`、***`Url`***|1. `$_序号`、`Title`、`$_Vehicle`、`$_OE`、`$_Pic`、***`Url`***、***`Vehicle_Url`***、`Src`、`其他Details`<br />2. ***`Vehicle_Url`***、`Vehicle`、`OE`|requests|
