...
- |网址|爬前操作|目录字段|内容字段||
  ...
  |12. [AutoteileDirekt](https://www.autoteiledirekt.de/suche.html?keyword=Radlagersatz%20SKF&brand%5B0%5D=50&pg=122)||<b><font color=red>1. Menu</font></b><sup>【Tampermonkey】</sup><br /><font color=blue>输入：</font>`Param_Keyword`<sub>[参数]</sub>、`Param_Pg`<sub>[参数]</sub><br /><font color=blue>输出：</font>`Page`、`No.`、`Url`<sup>(y)</sup>|<b><font color=red>2. Part</font></b><sup>【Tampermonkey】</sup><br /><font color=blue>输入：</font><u>`No.`</u><sub>[Menu]</sub>、`Url`<sub>[Menu]</sub><br /><font color=blue>输出：</font><u>`序号`</u>、`Title`、`Subtitle`、`Artkl`、`Product_Id`、`Price`、`Vehicle_1`<sup>(n)</sup>、`Vehicle_2`<sup>(n)</sup>、`OE`、`Kit`、`Pic`<sup>(n)</sup>、`Url`<sup>(n)</sup>、`Src`、`Maker_Id`、`其他Desc`、`其他TecDoc`<br /><br /><b><font color=red>3. Model</font></b><sup>【Tampermonkey】</sup><br /><font color=blue>输入：</font>`Product_Id`<sub>[Part]</sub>、`Maker_Id`<sub>[Part]</sub><br /><font color=blue>输出：</font>`Product_Id`、`Vehicle_1`<sup>(y)</sup><br /><font color=blue>输出_2：</font>`No.`、`Product_Id`、`Maker_Id`、`Model_Id`、`Vehicle_1`<br /><br /><b><font color=red>4. Engine</font></b><sup>【Tampermonkey】</sup><br /><font color=blue>输入：</font>`Product_Id`<sub>[Model_2]</sub>、`Maker_Id`<sub>[Model_2]</sub>、`Model_Id`<sub>[Model_2]</sub>、`Vehicle_1`<sub>[Part]</sub><br /><font color=blue>输出_1：</font>`No.`、`Product_Id`、`Model`<br /><font color=blue>输出：</font>`Product_Id`、`Vehicle_2`<sup>(y)</sup><br /><br /><b><font color=red>5. Pic</font></b><sup>【Tampermonkey】</sup><br /><font color=blue>输入：</font>`Src`<sub>[Part]</sub><br /><font color=blue>输出：</font><sup>(y)</sup>|yes|
