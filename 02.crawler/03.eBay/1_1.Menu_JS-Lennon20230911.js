...
(function() {
    ...
    window.onload = function() {
        ...
        let list_part = document.querySelector('ul.srp-results.srp-list.clearfix').querySelectorAll('div.s-item__image-section');
        for(let i=0; i<list_part.length; i++) {
            array_menu[i] = {};
            array_menu[i]['No.'] = i + 1;
            array_menu[i]['Url'] = list_part[i].querySelector('div').querySelector('a').getAttribute('href');
        }
