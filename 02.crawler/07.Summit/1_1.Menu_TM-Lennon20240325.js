...
// @description  Crawler
// @author       Lennon
// @match        *://www.summitracing.com/search?*
// @icon         https://www.summitracing.com/favicon.ico
// @grant        none
// ==/UserScript==
...
(function() {
    ...
    window.onload = function() {
        ...
        let list_part = document.querySelectorAll('div.columns.medium-17.large-18.show-for-medium>h2>a');
        for(let i=0; i<list_part.length; i++) {
            array_data[i] = {};
            array_data[i]['Page'] = param_page;
            array_data[i]['No.'] = i + 1;
            array_data[i]['Url'] = 'https://www.summitracing.com' + list_part[i].getAttribute('href').trim();
        }
