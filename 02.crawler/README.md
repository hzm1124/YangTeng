...
- |网址|爬前操作|目录字段|内容字段|爬取方法|
  ...
  |03. [eBay](https://www.ebay.com/sch/i.html?_dkr=1&iconV2Request=true&_blrs=recall_filtering&_ssn=zamo-zuan&store_cat=0&store_name=zamozuan&_oac=1&_nkw=motor%20mount)|1. `Sort` -> `Price + Shipping: highest first`<br />2. `Items per page` -> `240`<br /><br />价格分批筛选、_ul=US、_sop=16、_ipg=240、_stpos=91710、orig_cvip=true|<b><font color=blue>1. Menu</font></b><br /><b><font color=red>`Item_Number`</font></b>、`No.`|<b><font color=blue>2. Item</font></b><br /><font color=orange>`序号`</font>、<b><font color=red>`Item_Number`</font></b>、`Title`、`Subtitle`、`Price`、`Available`、`Sold`、<font color=orange>`Vehicle_1`</font>、<font color=orange>`Vehicle_2`</font>、<font color=orange>`Pic`</font>、`Url`、<b><font color=red>`Description`</font></b>、`Src`、<b><font color=red>`Vehicle_Page`</font></b>、<b><font color=red>`Category_Id`</font></b>、<b><font color=red>`Market_Id`</font></b>、`Country`、`Language`、`Locale`、`其他ItemSpecifics`<br /><br /><b><font color=blue>3. Vehicle</font></b><br /><b><font color=red>`Item_Number`</font></b>、<b><font color=purple>`Vehicle_1`</font></b>、<b><font color=purple>`Vehicle_2`</font></b><br />、<b><font color=red>`Vehicle_Page`</font></b>、<b><font color=red>`Category_Id`</font></b>、<b><font color=red>`Market_Id`</font></b><br /><br /><b><font color=blue>4. Description</font></b><br /><b><font color=red>`Description`</font></b>、`详情页信息`|requests|
  ...
  |16. [ATPAutoteile](https://www.atp-autoteile.de/de/search/n-243/o-1/b-1-592/bremsbelaege-bestprice-atec)|`Sortieren nach` -> `Preis absteigend`|<b><font color=blue>1. Menu</font></b><br />`Page`、<b><font color=red>`No.`</font></b>、<b><font color=red>`Url`</font></b>、<b><font color=purple>`Kit`</font></b>|<b><font color=blue>2. Part</font></b><br /><b><font color=red>`序号`</font></b>、`Sku`、`Title`、`Manufacturer`、`Mpn`、`Price`、<font color=orange>`Kit`</font>、<font color=orange>`Vehicle_1`</font>、<font color=orange>`Vehicle_2`</font>、`OE`、<font color=orange>`Pic`</font>、`Url`、`Src`、<b><font color=red>`Part_Code`</font></b>、<b><font color=red>`Make_Url`</font></b><br /><br /><b><font color=blue>3. Make</font></b><br /><b><font color=red>`Part_Code`</font></b>、`Make`、<b><font color=red>`Make_Code`</font></b>、<b><font color=red>`Model_Url`</font></b><br /><br /><b><font color=blue>4. Model</font></b><br /><b><font color=red>`Part_Code`</font></b>、<b><font color=purple>`Vehicle_1`</font></b>、<b><font color=purple>`Vehicle_2`</font></b>|JavaScript|
