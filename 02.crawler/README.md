...
- |网址|爬前操作|目录字段|内容字段|爬取方法|
  ...
  |12. [AutoteileDirekt](https://www.autoteiledirekt.de/suche.html?keyword=NISSENS&categories%5B%5D=447)||***`Url`***、`Part_Number`、`Title`、`Price`|***`Url`***、`OE`、`Vehicle`、`Src`、`tecdoc`|Tomcat|
